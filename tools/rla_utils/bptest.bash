...
# crtest -N 474 -R 1 -p '-1 1' -f /tmp/cvr.csv -F ../../test/e-1/arapahoe-manifest.csv -B tallyfile | tee $outdir/crtest.out  # 1157 * .41
# crtest -N 822 -R 1 -p '-1 1' -f /tmp/cvr.csv -F ../../test/e-1/arapahoe-manifest.csv -B tallyfile | tee $outdir/crtest.out # 1157 * .71 (50th percentile)
# crtest -N 2419 -R 1 -p '-1 1' -f /tmp/cvr.csv -F ../../test/e-1/arapahoe-manifest.csv -B tallyfile | tee $outdir/crtest.out # 1157 * 2.09 (90th percentile)
