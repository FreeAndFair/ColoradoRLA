...
public interface ASMTransitionFunction {
  ...
  enum CountyDashboardTransitionFunction implements ASMTransitionFunction {
    ONE(new ASMTransition(COUNTY_INITIAL_STATE, 
                          ...
                          AUDIT_BOARD_OK)),
    TWO(new ASMTransition(COUNTY_INITIAL_STATE,
                          COUNTY_START_AUDIT_EVENT,
                          DEADLINE_MISSED)),
    THREE(new ASMTransition(AUDIT_BOARD_OK, 
                            UPLOAD_BALLOT_MANIFEST_EVENT,
                            BALLOT_MANIFEST_OK)),
    FOUR(new ASMTransition(AUDIT_BOARD_OK, 
                           COUNTY_START_AUDIT_EVENT,
                           DEADLINE_MISSED)),
    FIVE(new ASMTransition(BALLOT_MANIFEST_OK, 
                           UPLOAD_CVRS_EVENT,
                           CVRS_OK)),
    SIX(new ASMTransition(BALLOT_MANIFEST_OK, 
                          COUNTY_START_AUDIT_EVENT,
                          DEADLINE_MISSED)),
    SEVEN(new ASMTransition(CVRS_OK, 
                            COUNTY_START_AUDIT_EVENT,
                            COUNTY_AUDIT_UNDERWAY)),
    EIGHT(new ASMTransition(COUNTY_AUDIT_UNDERWAY, 
                            COUNTY_AUDIT_COMPLETE_EVENT,
