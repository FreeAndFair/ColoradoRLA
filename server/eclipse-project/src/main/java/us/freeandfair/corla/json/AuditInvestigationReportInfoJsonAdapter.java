...
public final class AuditInvestigationReportInfoJsonAdapter 
    extends TypeAdapter<AuditInvestigationReportInfo> {
  /**
  ...
  /**
   * Writes an audit investigation report object.
   * 
   ...
   */
  @Override
  public AuditInvestigationReportInfo read(final JsonReader the_reader) 
      throws IOException {
    boolean error = false;
    ...
    while (the_reader.hasNext()) {
      ...
      switch (name) {
        ...
        case NAME:
          report_name = the_reader.nextString();
          break;
    ...
    return new AuditInvestigationReportInfo(timestamp, report_name, report);
  }
}
