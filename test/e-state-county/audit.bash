...
(
    ...
    ./main.py -c 1 -f ../e-state-county/cvr-1000--200.csv -F ../e-state/manifest-1-1000.csv county_setup
    ./main.py -c 2 -f ../e-state-county/cvr-10--2-4-1.csv -F ../e-state/manifest-2-10.csv county_setup
    ./main.py -c 3 -f ../e-state-county/cvr-100--24-40.csv -F ../e-state/manifest-3-100.csv county_setup

    echo -e "\nFinish 'Define audit' step to select contests, enter the random seed, and Lanuch the Audit\n"

    ./main.py -C 0 -C 1 -C 2 -C 3 -C 4 -C 5 dos_start
